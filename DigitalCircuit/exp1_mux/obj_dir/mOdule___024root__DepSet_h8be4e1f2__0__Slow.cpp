...
#endif
                VL_FATAL_MT("mux2.v", 1, "", "Settle region did not converge.");
            }
...
void mOdule___024root___ico_sequent__TOP__0(mOdule___024root* vlSelf);
...
VL_ATTR_COLD void mOdule___024root___dump_triggers__ico(mOdule___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    mOdule__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    mOdule___024root___dump_triggers__ico\n"); );
    // Body
