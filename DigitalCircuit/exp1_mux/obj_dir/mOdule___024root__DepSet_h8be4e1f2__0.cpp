...
VL_INLINE_OPT void mOdule___024root___ico_sequent__TOP__0(mOdule___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    mOdule__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    mOdule___024root___ico_sequent__TOP__0\n"); );
    // Body
    vlSelf->y = (((~ (IData)(vlSelf->s)) & (IData)(vlSelf->a)) 
                 | ((IData)(vlSelf->b) & (IData)(vlSelf->s)));
}

void mOdule___024root___eval_ico(mOdule___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    mOdule__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    mOdule___024root___eval_ico\n"); );
    // Body
    if (vlSelf->__VicoTriggered.at(0U)) {
        mOdule___024root___ico_sequent__TOP__0(vlSelf);
    }
}
...
void mOdule___024root___eval(mOdule___024root* vlSelf) {
    ...
    while (__VicoContinue) {
        __VicoContinue = 0U;
        mOdule___024root___eval_triggers__ico(vlSelf);
...
#endif
                VL_FATAL_MT("mux2.v", 1, "", "Input combinational region did not converge.");
            }
            vlSelf->__VicoIterCount = ((IData)(1U) 
                                       + vlSelf->__VicoIterCount);
            mOdule___024root___eval_ico(vlSelf);
        }
    }
    __VnbaIterCount = 0U;
    __VnbaContinue = 1U;
...
#endif
                    VL_FATAL_MT("mux2.v", 1, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("mux2.v", 1, "", "NBA region did not converge.");
            }
